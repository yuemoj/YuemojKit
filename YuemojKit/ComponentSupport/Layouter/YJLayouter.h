...
@protocol YJLayoutDelegate, YJLayoutOffsetDelegate;
...
- (instancetype)initWithDelegate:(id<YJLayoutDelegate, YJLayoutOffsetDelegate>)delegate NS_DESIGNATED_INITIALIZER;
